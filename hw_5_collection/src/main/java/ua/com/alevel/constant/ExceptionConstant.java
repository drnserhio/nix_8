...
public class ExceptionConstant {
    ...
    public static final String HAS_NULL_NUMBER = "You have null Number, check your date";
    public static final String OUT_INDEX_ARRAY = "You went out index of the array ";
    public static final String EMPTY_ARRAY = "Your array is empty: ";
