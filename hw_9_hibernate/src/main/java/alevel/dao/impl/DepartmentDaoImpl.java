...
public class DepartmentDaoImpl implements DepartmentDao {
    ...
    public void deleteDepartment(Long id) {
        session.getCurrentSession()
                .createQuery("delete from Department as department where department.id = :id")
                    .setParameter("id", id)
                    .executeUpdate();
    ...
    public Department findById(Long id) {
        ...
        try {
           department = currentSession.find(Department.class, id);
        } catch (Exception e) {
    ...
    public boolean existsDepartmentById(Long id) {
        return session.getCurrentSession()
                .createQuery("select count(id) from Department where id = :id")
    ...
    public List<Department> findAll() {
        return (List<Department>) session.getCurrentSession()
    ...
    public Employee findEmployeeById(Long employee_id) {
        ...
        try {
            employee = session.getCurrentSession().find(Employee.class, employee_id);
        } catch (Exception e) {
    ...
    public void updateDepartment(Department update) {
        if (existsDepartmentById(update.getId())) {
            ...
            if (departmentByNameCompany == null) {
                ...
                session.getCurrentSession().update(departmentByNameCompany);
            }
        } else {
